...
export default function TeamCard({ name, role, picture, description }) {
    return (
        <motion.div initial={{ opacity: 0, y: -30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ amount: 0.6, once: true }} whileHover={{ y: -15 }} className="relative rounded-lg overflow-clip min-h-[577px] min-w-[336px] max-h-[577px] max-w-[336px]">
