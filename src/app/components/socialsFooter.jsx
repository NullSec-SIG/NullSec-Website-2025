        ...
        <div className="flex flex-col items-center mb-15 gap-10">
            ...
            <div className="flex md:flex-row flex-col px-6 md:gap-14 gap-11 w-full">
                <div className="flex flex-col justify-end md:items-end items-center gap-11 flex-wrap md:w-1/2 w-full">
                    <motion.a initial={{ y: 0 }} whileHover={{ y: -5 }} href="mailto:nullsec.sig@gmail.com" target="blank" className="flex flex-row items-center border-[#F7C3BE] border-1 rounded-sm cursor-pointer select-none md:w-fit w-full">
                    ...
                    <motion.a initial={{ y: 0 }} whileHover={{ y: -5 }} href="https://github.com/NullSec-SIG" target="blank" className="flex flex-row items-center border-[#D9D9D9] border-1 rounded-sm cursor-pointer select-none md:w-fit w-full">
                ...
                <div className="flex flex-col justify-start md:items-start items-center gap-11 flex-wrap md:w-1/2 w-full">
                    <motion.a initial={{ y: 0 }} whileHover={{ y: -5 }} href="https://instagram.com/nullsec.sig" target="blank" className="flex flex-row items-center border-[#F7BEDC] border-1 rounded-sm cursor-pointer select-none md:w-fit w-full">
                    ...
                    <motion.a initial={{ y: 0 }} whileHover={{ y: -5 }} href="https://discord.gg/PEkgGHWjDq" target="blank" className="flex flex-row items-center border-[#E0E3FF] border-1 rounded-sm cursor-pointer select-none md:w-fit w-full">
