...
export default function HNF26Page() {
        ...
        <div className="flex flex-col">
                ...
                <motion.div initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1 }} onAnimationComplete={() => setFirstAnimationDone(true)} className="flex flex-col lg:text-left text-center px-6">
                    ...
                    <div initial={{ opacity: 0, y: 20 }} animate={{ opacity: firstAnimationDone ? 1 : 0, y: firstAnimationDone ? 0 : 20 }} transition={{ duration: 2.5 }}>
                        ...
                        <div className="flex flex-row lg:justify-start justify-center mt-5 gap-5">
                            <span className="pointer-events-none opacity-45 border-2 text-[#28c6f9] border-[#28c6f9] rounded-md md:text-xl text-lg w-fit px-6 py-2 select-none">
            ...
            <div className="flex flex-col items-center mt-10 px-4 min-h-svh">
                ...
                <motion.div initial={{ opacity: 0, y: -30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ amount: 0.8, once: true }} className="grid grid-cols-1 md:grid-cols-2 gap-y-1 md:gap-y-5 md:gap-x-14 lg:w-4/5 items-start">
                    <h2 className="md:text-2xl text-md font-bold md:text-right text-center">Qualifiers Start</h2>
                    <h2 className="md:text-2xl text-md md:text-left text-center">5 November 2026 9.00am</h2>

                    <div className="md:hidden m-2"></div>

                    <h2 className="md:text-2xl text-md font-bold md:text-right text-center">Qualifiers End</h2>
                    <h2 className="md:text-2xl text-md md:text-left text-center">6 November 2026 4.00pm</h2>

                    <div className="md:hidden m-2"></div>

                    <h2 className="md:text-2xl text-md font-bold md:text-right text-center">Finals</h2>
                    <h2 className="md:text-2xl text-md md:text-left text-center">7 November 2026</h2>

                    <div className="md:hidden m-2"></div>

                    <h2 className="md:text-2xl text-md font-bold md:text-right text-center">Medium</h2>
                    <h2 className="md:text-2xl text-md md:text-left text-center">Online (Qualifiers), Physical (Finals)</h2>

                    <div className="md:hidden m-2"></div>

                    <h2 className="md:text-2xl text-md font-bold md:text-right text-center">Location</h2>
                    <h2 className="md:text-2xl text-md md:text-left text-center">TBD</h2>
                    ...
                    <h2 className="md:text-2xl text-md md:text-left text-center">Pre-University, Open</h2>
                </motion.div>
                <Image src="/Line 1.png" width={1081} height={1} alt="border" className="mt-20 mx-auto w-4/5 select-none" />
                ...
                <motion.div initial={{ opacity: 0, y: -30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ amount: 0.2, once: true }} className="md:grid md:justify-items-center flex flex-col text-center w-full px-2 mb-10 gap-5" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))' }}>
                    ...
                    <div className="flex flex-col items-center md:border rounded-2xl p-10 md:w-md gap-5">
                        ...
                        <p className="text-center bottom-0">{"The challenge will automatically give you a flag enclosed with HNF26{} if you solved it"}</p>
                    </div>
                    <div className="flex flex-col items-center md:border rounded-2xl p-10 md:w-md gap-5">
