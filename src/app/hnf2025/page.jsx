...
export default function HNF2025Page() {
    ...
    return (
        <div className="flex flex-col">
            <div className="flex md:flex-row flex-col-reverse justify-center items-center min-h-svh md:gap-10 p-12">
                <div className="flex flex-col md:text-left text-center px-6">
                    ...
                    <div className="flex flex-row md:justify-start justify-center mt-5 gap-5">
                        <motion.a target="blank" initial={{ background: "transparent", color: "#02f053" }} whileHover={{ background: "#02f053", color: "black" }} href="https://hnf25.nullsecsig.com" className="border-2 border-[#02f053] text-black rounded-md text-xl w-fit px-6 py-2 cursor-pointer">
                            Play Now!
                        </motion.a>
                        <motion.a target="blank" initial={{ background: "transparent", color: "#28c6f9" }} whileHover={{ background: "#28c6f9", color: "black" }} href="https://forms.cloud.microsoft/r/mPrGngMKdi" className="border-2 border-[#28c6f9] rounded-md text-xl w-fit px-6 py-2 cursor-pointer">
                            Sign up
                        </motion.a>
                    </div>
                </div>
            ...
            <div className="flex flex-col items-center mt-10 min-h-svh">
                <h1 className="md:text-4xl text-3xl font-bold mb-10">DETAILS</h1>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 md:gap-y-5 md:gap-x-14 md:w-4/5 items-start">
                ...
                <Image src="/Line 1.png" width={1081} height={1} alt="border" className="mt-20 mx-auto w-4/5" />
                <h1 className="md:text-4xl text-3xl font-bold my-10">HOW TO PLAY</h1>
                <div className="md:grid md:justify-items-center flex flex-col text-center w-full px-10 mb-10 gap-5" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(400px, 1fr))'}}>
